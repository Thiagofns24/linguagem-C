...
int main (void){
    ...
    printf("Quantidade de Criancas: %d\n",quantidadeCriancas); //NOVA FUNCIONALIDADE
    printf("Quantidade de Adolescentes: %d\n",quantidadeAdolescentes); //NOVA FUNCIONALIDADE
    printf("Quantidade de Adultos: %d\n",quantidadeAdultos); //NOVA FUNCIONALIDADE
    printf("Quantidade de Idosos: %d\n",quantidadeIdosos); //NOVA FUNCIONALIDADE
    printf("Quantidade total de Homens: %d\n",sexoMasculino); //FOI PEDIDO NO PROJETO
    printf("Quantidade total de Mulheres: %d\n", sexoFeminino); //FOI PEDIDO NO PROJEto 
